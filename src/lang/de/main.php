...
$content['LN_GEN_SELECTSOURCE'] = "Quelle auswälen";
$content['LN_GEN_MOREPAGES'] = "Mehr als eine Seite verfügbar";
$content['LN_GEN_FIRSTPAGE'] = "Erste Seite";
$content['LN_GEN_LASTPAGE'] = "Letzte Seite";
$content['LN_GEN_NEXTPAGE'] = "Nächste Seite";
$content['LN_GEN_PREVIOUSPAGE'] = "Vorherige Seite";
$content['LN_GEN_RECORDCOUNT'] = "Alle gefundenen Einträge";
$content['LN_GEN_PAGERSIZE'] = "Einträge pro Seite";
...
$content['LN_GEN_CRITERROR_UNKNOWNTYPE'] = "Der Quell-Typ '%1' wird aktuell von LogAnalyzer nicht unterstützt. Dies ist ein kritischer Fehler, bitte passen Sie Ihre Konfiguration an.";
...
$content['LN_FOOTER_PAGERENDERED'] = "Seite berechnet in";
...
$content['LN_MENU_PROSERVICES'] = "Professionelle Unterstützung";
...
$content['LN_GRID_POPUPDETAILS'] = "Details für die Syslog-Meldung mit der ID '%1'";

$content['LN_SEARCH_USETHISBLA'] = "Bitte berücksichtigen Sie bei Ihrer Suche folgende Kriterien";
...
$content['LN_VIEW_MESSAGECENTERED'] = "Zurück zur ungefilterten Ansicht, mit dieser Meldung als erster";
...
$content['LN_VIEW_VISITLINK'] = "Öffne Link '%1' in neuem Fenster";
...
$content['LN_FILTER_ADD2SEARCH'] = "Zur Suche hinzufügen";
...
$content['LN_CFG_VIEW'] = "Anzeige auswählen";
...
$content['LN_GEN_ERROR_INVALIDFIELD'] = "Ungütiger Feldname";
$content['LN_GEN_ERROR_MISSINGCHARTFIELD'] = "Fehlender Feldname";
$content['LN_GEN_ERROR_INVALIDTYPE'] = "Ungültiger oder unbekannter Chart Typ";
...
$content['LN_STATS_WARNINGDISPLAY'] = "Das Erstellen von Grafiken über eine grosse Anzahl von Datensätzen kann sehr Prozessortlastig sein.<br>Dies wird in nachfolgenden Versionen noch weiter optimiert werden.<br>Falls die Erstellung der Grafiken zu viel Prozessortzeit in Anspruch nehmen sollte, bitte brechen Sie die Erstellung einfach ab.";
